function [ x,y,xe,ye,HalfLength,Beta,CosB,Points,NormAng,NUM,XBEG,XEND,YBEG,YEND ] = CreateElements2dQuad( Pointsxy,mystruct,FlipNormalsFlag )
...
[ x,y,xe,ye,HalfLength,Beta,CosB,Points,NormAng ] = MidPoint_OrientationQlocs( XBEG,XEND,YBEG,YEND,NUM );
