function [ CSS,TsMaxShr,TsMaxShrDir ] = CalculateMaximumCoulombStress(MidPoint,FaceNormalVector,Sxx,Syy,Szz,Sxy,Sxz,Syz,Mu,Cohesion,Points,Triangles,cmap )
% CalculateMaximumCoulombStress: Calculates the Coulomb stress change on an
...
%               
% usage #1:
%[ CSS ] = CalculateMaximumCoulombStress...
...
% Mu=0.6; 
% Cohesion=0.2;
% [ CSS,TsMaxShr,TsMaxShrDir ] = CalculateMaximumCoulombStress...
...
[ CSS ] = CalculateCoulombShearStress( Tn,abs(TsMaxShr),Mu,Cohesion );
